        ...
        <table class="table">
            <tr>
                ...
                <td style="width: 50%; vertical-align: top; text-align: right;border: none;">
                    ...
                    {{ $data->business->user_information->company_name ?? '' }}<br>
                    {{ $data->business->user_information->phone ?? '' }}/ {{ $data->business->mobile ?? '' }}<br>
                    {{ $data->business->user_information->street ?? '' }}, {{ $data->business->user_information->city ?? '' }}, {{ $data->business->user_information->zip_code ?? '' }}<br>
                    {{ $data->business->user_information->delivery_country ?? $data->delivery_country ?? '' }}
                </td>
            </tr>
        </table>
        ...
        <table class="table" style="margin-top: 10px;">
            ...
            @foreach($data->order_items as $item)
                <tr>
                    ...
                    <td class="align-right">{{ $item->item_price ?? '' }}</td>
                    <td class="align-right">{{ $item->item_total }}</td>
                    <td class="align-right">{{ $item->item_total + $item->total_vat }}</td>
                </tr>
            @endforeach
            </tbody>
        </table>
