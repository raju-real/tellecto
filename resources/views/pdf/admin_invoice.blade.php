            ...
            <tr>
                    ...
                    <table class="table">
                        <tr>
                            <td style="width: 50%; vertical-align: top;border: none;">
                                ...
                                {{ "Bagela AB (Tellecto)" }}<br>
                                {{ "Att: ". $data->delivery_name }} <br>
                                {{ "+46723208889" }}<br>
                                {{ "Skeppsgatan 19" }}<br>
                                {{ "Malmö" }} {{ "211 11 " }}<br>
                                {{ "Sweden" }}
                            ...
                            <td style="width: 50%; vertical-align: top; text-align: right;border: none;">
                                <strong style="font-size: 15px; color: balck">Shipping Address</strong><br>
                ...
                <td style="width: 40%;border: none;text-align: left;">
                    ...
                    <table class="table">
                        ...
                        <tr>
                            <td style="border: none;padding: 2px 4px;">Payment Terms</td>
                            <td style="border: none;padding: 2px 4px;">:</td>
        ...
        <table class="table" style="margin-top: 10px;">
            ...
            @foreach($data->order_items as $item)
                <tr>
                    ...
                    <td style="text-align: left;padding-left: 3px;">{{ $item->dcs_last_price ?? '' }} SEK</td>
                    <td style="text-align: left;padding-left: 3px;">{{ $item->item_total_admin }} SEK</td>
                    <td style="text-align: left;padding-left: 3px;">{{ $item->total_price_admin }} SEK</td>
                </tr>
            @endforeach
            ...
            <tr style="margin-top: 15px;border-top: 1px solid black;">
                ...
                <td style="text-align: left;padding-left: 3px;">{{ $data->dcs_delivery_charge ?? '' }} SEK</td>
                <td style="text-align: left;padding-left: 3px;">{{ $data->dcs_delivery_charge ?? '' }} SEK</td>
                <td style="text-align: left;padding-left: 3px;">{{ $data->dcs_delivery_charge ?? '' }} SEK</td>
            </tr>
            </tbody>
...
<div class="bottom-box" style="position: absolute;bottom: 2;">
    <div class="charge-box">
        <table class="table" style="margin-top: 30px;">
            ...
            <tbody>
            <tr>
                <td style="text-align: center;">{{ $data->total_excluding_vat_admin ?? 0.00 }}</td>
                <td style="text-align: center;">{{ $data->total_vat_admin ?? 0.00 }}</td>
                <td style="text-align: center;">0</td>
                <td style="text-align: center;">{{ $data->total_order_amount_admin ?? 0.00 }}</td>
            </tr>
            </tbody>
            </thead>
        </table>
