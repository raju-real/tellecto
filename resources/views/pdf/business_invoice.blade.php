                    ...
                    <table class="table">
                        <tr>
                            <td style="width: 50%; vertical-align: top;border: none;">
                                ...
                                {{ $data->agent_billing_address->street ?? '' }}<br>
                ...
                <td style="width: 40%;border: none;text-align: left;">
                    ...
                    <table class="table">
                        ...
                        <tr>
                            ...
                            <td style="border: none;padding: 2px 4px;">{{ $data->tellecto_order_no ?? '' }}</td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td style="border: none;padding: 2px 4px;">:</td>
                            <td style="border: none;padding: 2px 4px;">{{ $data->business->name ?? '' }}</td>
                        </tr>
                        <tr>
        ...
        <table class="table" style="margin-top: 10px;">
            ...
            @foreach($data->order_items as $item)
                <tr>
                    ...
                    <td style="text-align: left;padding-left: 3px;">{{ $item->tellecto_last_price ?? '' }} SEK</td>
                    <td style="text-align: left;padding-left: 3px;">{{ $item->item_total_business }} SEK</td>
                    <td style="text-align: left;padding-left: 3px;">{{ $item->total_price_business }} SEK</td>
                </tr>
            @endforeach
...
<div class="bottom-box" style="position: absolute;bottom: 2;">
    <div class="charge-box">
        <table class="table" style="margin-top: 30px;">
            <thead>
            <tr style="background-color: black">
                <th style="color: white;text-align: center;background-color: black">Net amount</th>
                <th style="color: white;text-align: center;background-color: black">Total vat. amount</th>
                <th style="color: white;text-align: center;background-color: black">Vat rate</th>
                <th style="color: white;text-align: center;background-color: black">Total amount SEK</th>
            </tr>
            </thead>
            <tbody>
            <tr>
                <td style="text-align: center;">{{ $data->total_excluding_vat_business ?? 0.00 }}</td>
                <td style="text-align: center;">{{ $data->total_vat_business ?? 0.00 }}</td>
                <td style="text-align: center;">{{ '25% / 0%' }}</td>
                <td style="text-align: center;">{{ $data->total_order_amount_business ?? 0.00 }}</td>
            </tr>
            </tbody>
            </thead>
        </table>
