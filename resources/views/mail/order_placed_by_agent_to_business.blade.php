...
<p>
    We would like to inform you that an order has been successfully placed by your agent, {{ $mail_data['order']['agent']['full_name'] }}, on the TELLECTO B2B eCommerce platform.
</p>
...
<br>
<p>Log into your TELLECTO account at <a href="https://tellecto.se/my-account/orders">https://tellecto.se/my-account/orders</a>  to track the status of your order and view further details.</p>
