...
<p>
    We are pleased to inform you that your order #{{ $mail_data['order']['tellecto_order_no'] }}, placed on behalf
    of {{ $mail_data['order']['business']['user_information']['company_name'] }}, has been approved by the TELLECTO team
...
<p><a href="https://tellecto.se/my-account/orders ">https://tellecto.se/my-account/orders </a></p>
<br>
