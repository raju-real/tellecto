...
<p>
    We regret to inform you that your order #{{ $mail_data['order']['tellecto_order_no'] ?? '' }}, placed by {{ $mail_data['order']['agent']['full_name'] ?? '' }}, has been rejected by the TELLECTO team.
</p>
...
<ol style="list-style-type: disc; list-style-position: inside;">
    ...
    <li><strong>Reject by: </strong> {{ getUserNameByID($mail_data['order']['rejected_by']) ?? '' }}</li>
</ol>

<br>
<p>Reason for Rejection:</p>
<p>{{ $mail_data['order']['rejected_for'] ?? 'N/A' }}</p>
