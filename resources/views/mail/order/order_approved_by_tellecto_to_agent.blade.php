                                                            ...
                                                            <table bgcolor="#fff" width="100%" border="0"
                                                                ...
                                                                <tr>
                                                                    <td align="left" valign="top"
                                                                        ...
                                                                        placed on behalf
                                                                        of {{ $mail_data['order']['business']['user_information']['company_name'] }}
                                                                        , has been approved by the TELLECTO team
                                                                ...
                                                                <tr>
                                                                    <td align="left" valign="top"
                                                                        style="font-family:Arial, Helvetica, sans-serif; font-size:16px; line-height:20px; color:#222; padding: 0 25px;">
                                                                        For any questions or additional details, feel
                                                                ...
                                                                <tr>
                                                                    <td align="left" valign="top"
                                                                        style="font-family:Arial, Helvetica, sans-serif; font-size:16px; line-height:20px; color:#222; padding: 0 25px;">
                                                                        Thank you for choosing TELLECTO!
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <td bgcolor="#fff" height="30"
                                                        ...
                                                        <td valign="top" bgcolor="#fff">
                                                            <table bgcolor="#fff" width="100%" border="0"
                                                                ...
                                                                <tr>
                                                                    <td align="left" valign="top"
                                                                        style="font-family:Arial, Helvetica, sans-serif; font-size:16px; line-height:20px; color:#222; padding-left: 25px;">
                                                                        {{ $mail_data['order']['delivery_address'] ?? '' }}, {{ $mail_data['order']['delivery_zip'] }} {{ $mail_data['order']['delivery_city'] }}, {{ $mail_data['order']['delivery_zip'] }} {{ $mail_data['order']['delivery_city'] }}
                                                                    </td>
                                                                </tr>
                                                                <tr>
