                                                ...
                                                <table bgcolor="#ffffff" width="100%" border="0" cellspacing="0"
                                                    ...
                                                    <tr>
                                                        <td align="center" valign="top"
                                                            ...
                                                            Order
                                                            <b>#{{ $mail_data['order']['tellecto_order_no'] ?? '' }}</b>
                                                            Approved by Business Owner – Action Required
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                            ...
                                                            <table bgcolor="#fff" width="100%" border="0"
                                                                ...
                                                                <tr>
                                                                    <td align="left" valign="top"
                                                                        ...
                                                                        We are pleased to inform you that the business
                                                                        owner
                                                                        of {{ $mail_data['order']['agent_billing_address']['company_name'] }}
                                                                        has approved order
                                                                        #{{ $mail_data['order']['tellecto_order_no'] }},
                                                                        placed by their agent on the TELLECTO B2B
                                                                        eCommerce platform.
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                        ...
                                                                        <table bgcolor="#fff" width="100%" border="0"
                                                                            ...
                                                                            <tr>
                                                                                <td align="center" valign="top"
                                                                                    ...
                                                                                    <a class="btn"
                                                                                       href="https://admin.tellecto.se/login">Order
                                                                                        Status</a>
                                                                                </td>
                                                                            </tr>
                                                                        </table>
                                                                            ...
                                                                            <table bgcolor="#fff" width="95%" border="0"
                                                                                ...
                                                                                <tr>
                                                                                        ...
                                                                                        <table bgcolor="#fff"
                                                                                            ...
                                                                                            <tr>
                                                                                                <td align="left"
                                                                                                    ...
                                                                                                    PRICE:&nbsp;<b>{{ $item->tellecto_last_price ?? ''  }}</b>,
                                                                                    ...
                                                                                    <td align="right" valign="top"
                                                                                        ...
                                                                                        {{--                                                                                            4990</b><br/>--}}
                                                                                        <b style="color: #ff0000;">SEK {{ $item->item_total_business ?? '' }}</b>
                                                                                    </td>
                                                                                </tr>
                                                                            </table>
                                                                        </td>
                                                                                    ...
                                                                                    <table width="100%" border="0"
                                                                                        ...
                                                                                        <tr>
                                                                                            ...
                                                                                            <td align="right"
                                                                                                ...
                                                                                                SEK {{ $mail_data['order']['total_sales_amount_admin'] ?? '' }}
                                                                                            </td>
                                                                                            <td bgcolor="#fff"
                                                                                                width="25px" height="30"
                                                                                                style="font-size:0px; line-height:0px;">
                                                                                    ...
                                                                                    <table width="100%" border="0"
                                                                                        ...
                                                                                        <tr>
                                                                                            ...
                                                                                            <td align="right"
                                                                                                valign="top"
                                                                                                style="width:45%; font-family:Arial, Helvetica, sans-serif; font-size:16px; line-height:20px; color:#222; padding-left: 25px;">
                                                                                                SEK {{ $mail_data['order']['total_vat_business'] }}
                                                                                            </td>
                                                                                            <td bgcolor="#fff"
                                                                                                width="25px" height="30"
                                                                                                style="font-size:0px; line-height:0px;">
                                                                        ...
                                                                        <table width="100%" border="0" cellspacing="0"
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <td align="right" valign="top"
                                                                                    ...
                                                                                    <b>SEK {{ $mail_data['order']['total_order_amount_business'] ?? '' }}</b>
                                                                                </td>
                                                                                <td bgcolor="#fff" width="25px"
                                                                                    height="30"
                                                                                    style="font-size:0px; line-height:0px;">
